...
export default class TextField extends PureComponent {
  ...
  static propTypes = {
    ...
    inputRowStyle: ViewPropTypes.style,
    lineStateAnimation: PropTypes.instanceOf(Animated.Value),
  }
  ...
  static getDerivedStateFromProps({ error, value, defaultValue }, state) {
    let newState = {}
  ...
  inputStyle() {
    let { fontSize, baseColor, textColor, disabled, multiline, disabledTextColor } = this.props

    let color = disabled || this.isDefaultVisible() ? disabledTextColor || baseColor : textColor
